...
## Архитектура программы. Оптимизации.
...
![Рис.2, архитектура вычислений.](pic/architecture.png)
...
![Рис.3, пример визуализации в программе ParaView.](pic/example.png)
...
![Рис.4, совмещенные графики задержки и пропускания](pic/delay_and_transmission.png)
